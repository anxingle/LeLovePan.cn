...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    $you = "盼盼";
    $me = "乐乐";
    $yi = "爱是恒久忍耐，又有恩慈；  爱是不嫉妒；爱是不自夸；  不张狂；不作害羞的事；  不求自己的益处；不轻易发怒；  不计算人的恶；不喜欢不义；";
    $wu = "我的傻妞，做你的守护者";
    $year = '2014';
    $yue = '6';
    $ri = '29';
            ...
            <div id="error">本页面采用HTML5编辑，目前您的浏览器无法显示，请换成谷歌(<a href="http://rj.baidu.com/soft/detail/14744.html?ald">Chrome</a>)或者火狐(<a href="http://rj.baidu.com/soft/detail/11843.html">Firefox</a>)浏览器，或者其他游览器的最新版本。</div>
             <div id="wrap">
                <div id="text">
				  ...
				  <span class="say"><?php echo $yi; ?></span><br>


       <span class="say">亲爱的盼盼</span><br>
						<span class="say"> </span><br>
                        <span class="say"><span class="space"></span><?php echo $wu; ?></span><br>
						&nbsp;&nbsp;&nbsp;<span class="say"><span class="space"></span> <?php echo $me; ?></span>
			  </font></p>
      </div>
                </div>
                <div id="clock-box">
...
<span class="STYLE1"> 默默走过了</span>
    ...
    <script>
		function backCA(){
			document.getElementById('go_right').className="add";
			}
		function backCD(){
			document.getElementById('go_right').className="";
			}
    </script>
    ...
    (function(){
        ...
        var textAnimate = eval(Jscex.compile("async", function () {
		    ...
		    together.setFullYear(<?php echo $year; ?>,<?php echo $yue; ?>-1,<?php echo $ri; ?>); 			//时间年月日
